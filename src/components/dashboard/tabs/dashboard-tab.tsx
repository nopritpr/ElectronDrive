...
export default function DashboardTab({
  ...
  return (
    <div className="h-full grid grid-cols-12 grid-rows-6 gap-4 min-h-0">
      {/* Left Column */}
      <Card className="col-span-12 md:col-span-3 row-span-2 md:row-span-2 p-4 flex flex-col">
      ...
      <Card className="col-span-12 md:col-span-3 row-span-2 md:row-span-2 p-4">
      ...
      {/* Center Column */}
      <Card className="col-span-12 md:col-span-6 row-span-6 md:row-span-6 p-4 flex flex-col relative">
        <NavigationMap />
      </Card>

      {/* Right Column */}
      <div className="col-span-12 md:col-span-3 row-span-2 md:row-span-2 grid grid-cols-2 gap-4">
      ...
      <div className="col-span-12 md:col-span-3 row-span-2 md:row-span-2">
        <Weather weather={weather} forecast={forecast} />
      </div>

      <Card className="col-span-12 md:col-span-3 row-span-2 p-4">
